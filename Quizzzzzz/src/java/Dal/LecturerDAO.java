...
////load single record directly////////////////////////////////////////////////////////////////////////////////////
    ...
    public Account loadALecturerofClass(String classID)
            {
                String sql = "SELECT account.Account_ID, account.Name, account.Email FROM account join lecturerinwhichclass on account.Account_ID = lecturerinwhichclass.Lecturer_ID where Class_ID like ? and account.Status = 1";
                try
                     {
                         PreparedStatement ps = connector.prepareStatement(sql);
                         ps.setString(1, classID);
...
//        System.out.println(dao.getDateforDisplay("date", ));
        ...
        String endDate = "2023/11/25";
        
            if(todayDate.compareTo(LocalDate.parse(startDate,DateTimeFormatter.ofPattern("yyyy/MM/dd")))>-1&&todayDate.compareTo(LocalDate.parse(endDate,DateTimeFormatter.ofPattern("yyyy/MM/dd")))<0)
                {
