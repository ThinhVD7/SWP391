...
public class Lecturer extends Account {
    ...
    public Lecturer(String accountID, String name, String email, String password, int roleID, int status, float gender, long phoneNumber, String department, String meetlink) {
