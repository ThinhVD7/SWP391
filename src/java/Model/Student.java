...
public class Student extends Account{
    ...
    public Student(String accountID, String name, String email, String password, int roleID, int status, float gender, long phoneNumber, String major, String schoolYear) {
