...
public class studentExamList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet studentExamList</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet studentExamList at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException 
    {
        ...
        session.setAttribute("sessionPageTitle", thisClass.getCourseID()+" "+dao.loadACourse(thisClass.getCourseID()).getSemester());
        //sessionThisClass
        session.setAttribute("sessionThisClass", thisClass);
        //sessionThisCourse
        session.setAttribute("sessionThisCourse", dao.loadACourse(thisClass.getCourseID()));
        ...
        request.getRequestDispatcher("studentExamList.jsp").forward(request, response);
    } 
