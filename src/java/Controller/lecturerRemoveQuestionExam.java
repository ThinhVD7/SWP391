 ...
 * @author tanki
 */
public class lecturerRemoveQuestionExam extends HttpServlet {
...
//        processRequest(request, response);
        ...
        dao.updateExamScore(e.getExamID(), String.valueOf(e.getMaxScore()-(dao.getAQuestion(request.getParameter("questionID")).getMark())), String.valueOf(e.getQuestionNumber()-1));
