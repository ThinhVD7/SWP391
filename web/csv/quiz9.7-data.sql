...
-- Schema quiz9.7
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `quiz9.7` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `quiz9.7` ;

-- -----------------------------------------------------
-- Table `quiz9.7`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`role` (
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`account` (
  ...
  CONSTRAINT `Role_ID`
    FOREIGN KEY (`Role_ID`)
    REFERENCES `quiz9.7`.`role` (`Role_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`question` (
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`choicesofquestion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`choicesofquestion` (
  ...
  CONSTRAINT `choice_question`
    ...
    REFERENCES `quiz9.7`.`question` (`Question_ID`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`course`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`course` (
...
-- Table `quiz9.7`.`class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`class` (
  ...
  CONSTRAINT `Class_Course`
    ...
    REFERENCES `quiz9.7`.`course` (`Course_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- Table `quiz9.7`.`exam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`exam` (
  ...
  CONSTRAINT `Exam_Class`
    ...
    REFERENCES `quiz9.7`.`class` (`Class_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`lecturer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`lecturer` (
  ...
  CONSTRAINT `Lecturer_ID`
    ...
    REFERENCES `quiz9.7`.`account` (`Account_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`lecturerinwhichclass`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`lecturerinwhichclass` (
  ...
  CONSTRAINT `lecturer`
    FOREIGN KEY (`Lecturer_ID`)
    REFERENCES `quiz9.7`.`lecturer` (`Lecturer_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`questioninwhichexam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`questioninwhichexam` (
  ...
  CONSTRAINT `Bank_Exam`
    FOREIGN KEY (`Exam_ID`)
    REFERENCES `quiz9.7`.`exam` (`Exam_ID`)
    ON DELETE CASCADE
    on update cascade,
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`student` (
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`studentresult`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`studentresult` (
  ...
  CONSTRAINT `ResultStudent`
    FOREIGN KEY (`Student_ID`)
    REFERENCES `quiz9.7`.`student` (`Student_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`studentanswer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`studentanswer` (
  `StudentAnswer_ID` VARCHAR(100) NOT NULL,
  `Question_ID` INT NULL DEFAULT NULL,
  `Choice_ID` INT NULL DEFAULT NULL,
  `Result_ID` VARCHAR(100) NULL DEFAULT NULL,
  ...
  INDEX `answer_result_idx` (`Result_ID` ASC) VISIBLE,
  CONSTRAINT `answer_choice`
    FOREIGN KEY (`Choice_ID`)
    REFERENCES `quiz9.7`.`choicesofquestion` (`Choice_ID`)
    ON DELETE CASCADE,
  CONSTRAINT `answer_question`
    FOREIGN KEY (`Question_ID`)
    REFERENCES `quiz9.7`.`question` (`Question_ID`)
    ON DELETE CASCADE,
  CONSTRAINT `answer_result`
    FOREIGN KEY (`Result_ID`)
    REFERENCES `quiz9.7`.`studentresult` (`Result_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.7`.`studentinwhichclass`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`studentinwhichclass` (
  `Student_ID` VARCHAR(50) NOT NULL,
  `Class_ID` VARCHAR(50) NOT NULL,
...
-- Table `quiz9.7`.`bank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.7`.`bank` (
...
START TRANSACTION;
USE `quiz9.7`;
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('MAS291', 'Mathematics and Statistics', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('EXE101', 'Elicit Xperiences for Elites', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('SWP491', 'Exit Extrance', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('SSL102', 'Random Keystroke Simulation', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('NWC203', 'Random Keystroke Simulation 2', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('ITE302', 'Random Keystroke Simulation 3', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('SSG102', 'Charity Simulation', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('JPD134', 'Japanese 3', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('ACC101', 'Accountant 101', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('CNH123', 'Chinese 2', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('ENW224', 'Economics 2', 'Fall 2023', '2023/09/03', '2023/11/02');
INSERT INTO course (`Course_ID`, `CourseName`, `Semester`, `StartDate`, `EndDate`) VALUES ('MKT101', 'Marketing 101', 'Fall 2023', '2023/09/03', '2023/11/02');
...
START TRANSACTION;
USE `quiz9.7`;
INSERT INTO `quiz9.7`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 1', 10, '2023-09-20T09:00:00', '2023-11-20T11:00:00', '00:45:00', 'Do this or die', 16, 1,'minhvnt_he_176043');
INSERT INTO `quiz9.7`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 2', 0, '2023-09-20T09:10:00', '2023-09-20T11:10:00', '00:30:23', 'Do or not to do', 0, 0,'minhvnt_he_176043');
INSERT INTO `quiz9.7`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 3', 0, '2023-09-20T09:30:00', '2023-09-20T11:30:00', '01:00:02', 'Welcome gosujinsama', 0, 0,'minhvnt_he_176043');
INSERT INTO `quiz9.7`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Final Trial', 0, '2023-09-20T09:00:00', '2023-10-20T09:00:00', '00:00:30', 'Die yet', 0, 1,'minhvnt_he_176043');

COMMIT;

-- Data for table `quiz9.7`.`question`
-- -----------------------------------------------------
START TRANSACTION;
USE `quiz9.7`;
...
START TRANSACTION;
USE `quiz9.7`;
INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 1);
INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 2);
INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 3);
INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 4);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 5);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 6);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 7);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 8);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 9);
-- INSERT INTO `quiz9.7`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 10);
...
START TRANSACTION;
USE `quiz9.7`;
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '1', 100);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '2', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '9', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '0', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '1', 50);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '2', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '0', 50);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '3', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', '0', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', '1', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', 'How?', 100);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Chicken', 33);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Dog', 33);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Rabbit', 33);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'J.Man', 0);
INSERT INTO `quiz9.7`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Don\'t know', 0);
...
-- -----------------------------------------------------
-- Data for table `quiz9.7`.`bank`
-- -----------------------------------------------------
START TRANSACTION;
USE `quiz9.7`;
INSERT INTO `quiz9.7`.`bank` (`Bank_ID`, `Course_ID`, `Lecturer_ID`, `Question_ID`, `BankName`) VALUES (1, 'MAS291', 'minhvnt_he_176043', 1, 'MAS291_SE1732_minhvnthe176043_1');
INSERT INTO `quiz9.7`.`bank` (`Bank_ID`, `Course_ID`, `Lecturer_ID`, `Question_ID`, `BankName`) VALUES (2, 'MAS291', 'minhvnt_he_176043', 2, 'MAS291_SE1732_minhvnthe176043_1');
