...
<style>body {background: #FFFFFF; margin: 5px; color: #000000} p {margin: 0; line-height: 1.5; overflow: hidden;} a {text-decoration:none;color:#ea4335}a:hover{color:#cf2415}</style>
</head>
<body>
    <h3><p><b>Error 404.</b> <i>Page not found.</i></p>
