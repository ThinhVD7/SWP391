            ...
            <div class="main-container">
                ...
                <div>
                    <a style ="padding: 5px;"
                       href="home">Home</a> / 
                    <a style ="padding: 5px;" 
                       href="studentExamList?classID=${sessionScope.sessionThisClass.classID}">${sessionScope.sessionThisClass.className} - ${sessionScope.sessionThisClass.courseID}</a> /
                    <a style ="padding: 5px;" 
                ...
                <div class="exam-detail">
                    <c:if test="${requestScope.isDoQuizz == false}">
