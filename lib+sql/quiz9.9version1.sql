...
-- Schema quiz9.9
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `quiz9.9` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `quiz9.9` ;

-- -----------------------------------------------------
-- Table `quiz9.9`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`role` (
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`account` (
  ...
  CONSTRAINT `Role_ID`
    FOREIGN KEY (`Role_ID`)
    REFERENCES `quiz9.9`.`role` (`Role_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`question` (
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`choicesofquestion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`choicesofquestion` (
  ...
  CONSTRAINT `choice_question`
    ...
    REFERENCES `quiz9.9`.`question` (`Question_ID`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`course`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`course` (
...
-- Table `quiz9.9`.`class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`class` (
  ...
  CONSTRAINT `Class_Course`
    ...
    REFERENCES `quiz9.9`.`course` (`Course_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- Table `quiz9.9`.`exam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`exam` (
  ...
  CONSTRAINT `Exam_Class`
    ...
    REFERENCES `quiz9.9`.`class` (`Class_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`lecturer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`lecturer` (
  ...
  CONSTRAINT `Lecturer_ID`
    ...
    REFERENCES `quiz9.9`.`account` (`Account_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`lecturerinwhichclass`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`lecturerinwhichclass` (
  ...
  CONSTRAINT `lecturer`
    FOREIGN KEY (`Lecturer_ID`)
    REFERENCES `quiz9.9`.`lecturer` (`Lecturer_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`questioninwhichexam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`questioninwhichexam` (
  ...
  CONSTRAINT `Bank_Exam`
    FOREIGN KEY (`Exam_ID`)
    REFERENCES `quiz9.9`.`exam` (`Exam_ID`)
    ON DELETE CASCADE
    on update cascade,
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`student` (
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`studentresult`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`studentresult` (
  ...
  CONSTRAINT `ResultStudent`
    FOREIGN KEY (`Student_ID`)
    REFERENCES `quiz9.9`.`student` (`Student_ID`)
    ON DELETE CASCADE
    on update cascade)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`studentanswer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`studentanswer` (
  ...
  CONSTRAINT `answer_choice`
    ...
    REFERENCES `quiz9.9`.`choicesofquestion` (`Choice_ID`)
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`studentinwhichclass`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`studentinwhichclass` (
  `Student_ID` VARCHAR(50) NOT NULL,
  `Class_ID` VARCHAR(50) NOT NULL,
...
-- Table `quiz9.9`.`bank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`bank` (
...
-- -----------------------------------------------------
-- Table `quiz9.9`.`questioninwhichbank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `quiz9.9`.`questioninwhichbank` (
  `Bank_ID` INT NULL,
  ...
  CONSTRAINT `bank1`
    FOREIGN KEY (`Bank_ID`)
    REFERENCES `quiz9.9`.`bank` (`Bank_ID`)
    ON DELETE cascade
    ON UPDATE NO ACTION,
  CONSTRAINT `bank2`
    FOREIGN KEY (`Question_ID`)
...
START TRANSACTION;
USE `quiz9.9`;
INSERT INTO `quiz9.9`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 1', 10, '2023-09-20T09:00:00', '2023-11-20T11:00:00', '00:45:00', 'Do this or die', 16, 1,'minhvnt_he_176043');
INSERT INTO `quiz9.9`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 2', 0, '2023-09-20T09:10:00', '2023-09-20T11:10:00', '00:30:23', 'Do or not to do', 0, 0,'minhvnt_he_176043');
INSERT INTO `quiz9.9`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Progress Test 3', 0, '2023-09-20T09:30:00', '2023-09-20T11:30:00', '01:00:02', 'Welcome gosujinsama', 0, 0,'minhvnt_he_176043');
INSERT INTO `quiz9.9`.`exam` (`Class_ID`, `ExamName`, `QuestionNumber`, `StartDate`, `EndDate`, `TimeLimit`, `ExamDetail`, `MaxScore`, `Permission`,`CreatedBy`) VALUES ('SE1732_MAS291', 'Final Trial', 0, '2023-09-20T09:00:00', '2023-10-20T09:00:00', '00:00:30', 'Die yet', 0, 1,'minhvnt_he_176043');

COMMIT;

-- Data for table `quiz9.9`.`question`
-- -----------------------------------------------------
START TRANSACTION;
USE `quiz9.9`;
...
START TRANSACTION;
USE `quiz9.9`;
INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 1);
INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 2);
INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 3);
INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 4);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 5);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 6);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 7);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 8);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 9);
-- INSERT INTO `quiz9.9`.`questioninwhichexam` (`Exam_ID`, `Question_ID`) VALUES ('1', 10);
...
START TRANSACTION;
USE `quiz9.9`;
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '1', 100);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '2', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '9', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('1', '0', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '1', 50);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '2', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '0', 50);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('2', '3', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', '0', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', '1', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('3', 'How?', 100);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Chicken', 33);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Dog', 33);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Rabbit', 33);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'J.Man', 0);
INSERT INTO `quiz9.9`.`choicesofquestion` (`Question_ID`, `ChoiceContent`, `ScorePercentage`) VALUES ('4', 'Don\'t know', 0);
...
-- -----------------------------------------------------
-- Data for table `quiz9.9`.`bank`
-- -----------------------------------------------------
START TRANSACTION;
USE `quiz9.9`;
INSERT INTO `quiz9.9`.`bank` (`Bank_ID`, `Course_ID`, `Lecturer_ID`, `BankName`) VALUES (1, 'MAS291', 'minhvnt_he_176043', 'MAS291_SE1732_minhvnthe176043');

START TRANSACTION;
USE `quiz9.9`;
INSERT INTO `quiz9.9`.`questioninwhichbank` (`Bank_ID`, `Question_ID`) VALUES (1, 1);
INSERT INTO `quiz9.9`.`questioninwhichbank` (`Bank_ID`, `Question_ID`) VALUES (1, 2);

COMMIT;

-- START TRANSACTION;
-- USE `quiz9.9`;
-- INSERT INTO `quiz9.9`.`studentresult` (`Result_ID`, `Exam_ID`, `Student_ID`, `TotalScore`, `TotalTime`, `State`) VALUES ('1', 1, 'Z', 1, '1', 1);
-- INSERT INTO `quiz9.9`.`studentresult` (`Result_ID`, `Exam_ID`, `Student_ID`, `TotalScore`, `TotalTime`, `State`) VALUES ('2', 1, 'Z', 3, '4', 5);
